...
<html><head>
  ...
  <link rel="stylesheet" type="text/css" href="${contextPath}/resources/css/main/common/locService.css?after"/>
</head>
<body>
	<div class="page-content">
		<div class="wrapper">
			<h1><img class="billy_img" src="${contextPath}/resources/images/logo.png" align=middle>위치기반서비스 이용약관<p></h1>

			<h3>제1조 (목적)</h3>
			
			<p>본 약관은 회원이 빌리어스가 제공하는 위치기반서비스(이하 “서비스”라고 합니다)를 이용함에 있어 회사와 회원의 권리・의무 및 책임사항을 규정함을 목적으로 합니다.</p>
			...
			<ol>
				<li>본회사는 아래와 같은 경우에는 여러분의 당근마켓 계정 생성을 유보할 수 있습니다.
			...
			<ol>
				...
				<li>
					...
					<ol>
						<li>종류 : 렌탈 서비스</li>
						<li>서비스명 : 빌리어스</li>
						<li>설명 : 주변 이웃과 중고물품을 렌탈하는 시스템</li>
						<li>위치정보 이용 목적: 주소 확인</li>
						<li>이용 요금 : 무료</li>
					</ol>
				</li>
			</ol>
			...
			<h3>제8조 (서비스내용변경 통지 등)</h3>
			
			<ol>
				<li>회사가 서비스 내용을 변경하거나 종료하는 경우 회사는 회원의 등록된 휴대폰 번호 문자 방식으로 서비스 내용의 변경 사항 또는 종료를 통지할 수 있습니다.</li>
			...
			<p>제1조 (시행일) 본 약관은 2017년 12월 1일부터 시행합니다.</p>
