				...
				<div class="borrow-list">
					...
					<!-- lending-list-inform - End -->
						...
						<div class="borrow-buttonList">
								...
								<c:choose>
									<c:when test="${goodsList.reserveList[0].transaction_status == '결제완료'}">		
										
										<div class="btn-source" id="accept-btn">
											<form action="/transaction/takeOver.do" id="takeOver" name="takeOver">
												<input type="hidden" name="reserve_NUM" value="${goodsList.reserveList[0].reserve_NUM}"/>
												<button type="submit"class="buttonList" id="takeOverButton" onclick="takeOver(this.form)">
													물품인수 확인
												</button>
											</form>
										</div>
